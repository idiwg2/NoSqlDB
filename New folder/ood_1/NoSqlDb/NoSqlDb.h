...
public:
  ...
  std::string PersistingDatabaseContenttoXml(NoSqlDb<Data>& db); // method to write database content into xml file
...
std::string NoSqlDb<Data>::PersistingDatabaseContenttoXml(NoSqlDb<Data>& db)
{
